          ...
          <div className="flex items-center justify-end gap-2">
            <div
              className={`inline-flex items-center bg-white border rounded-xl px-3.5 h-9 transition-colors ${
                hasUnappliedChanges ? "border-emerald-300 ring-1 ring-emerald-100" : "border-slate-200"
              }`}
            >
              <Calendar className="h-3.5 w-3.5 text-emerald-600 mr-2 shrink-0" aria-hidden="true" />
              <input
                type="date"
                value={startDate}
