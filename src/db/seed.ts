...
async function main() {
  ...
  // 12. Permissions Catalog (8 modules × 4 actions)
  const modules = [
    "dashboard",
    "employees",
    "attendance",
  ...
  const roleData = [
    ...
    },
    {
      ...
      modules: ["dashboard", "employees", "attendance", "assets", "tasks", "complaints", "inventory", "approvals"],
    },
    {
      name: "site_engineer",
      description: "Asset and task management",
      modules: ["dashboard", "assets", "tasks", "complaints", "inventory"],
    },
    {
      name: "hr_manager",
      description: "Employee and attendance management",
      modules: ["dashboard", "employees", "attendance"],
    },
    {
      name: "accountant",
      description: "Financial approvals and inventory",
      modules: ["dashboard", "inventory", "approvals"],
    },
    {
      name: "supervisor",
  ...
  // Determine which actions each role gets per module
  ...
  // 14. Approval Workflow Definitions
  const workflowData = [
    {
