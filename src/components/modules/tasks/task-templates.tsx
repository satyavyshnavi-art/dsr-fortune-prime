  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <Button
          className="h-8 text-[12px] px-3 gap-1.5 bg-blue-600 hover:bg-blue-700 text-white"
      ...
      <Dialog open={showForm} onOpenChange={setShowForm}>
        <DialogContent className="sm:max-w-[520px] p-5 max-h-[85vh] overflow-y-auto" showCloseButton>
          ...
          <div className="space-y-3 pt-2">
            ...
            <Button
              onClick={handleSave}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white h-9 text-[13px] rounded-lg"
            >
