    ...
    <Card className="shadow-none border-slate-200">
      <CardContent className="p-3 space-y-3">
        ...
        <div className="flex justify-end">
          <Button className="h-7 text-[11px] bg-teal-600 hover:bg-teal-700 text-white gap-1.5 px-2.5" onClick={() => onSave({ ...form, plantType: "stp" })}>
  ...
  return (
    <Card className="shadow-none border-slate-200">
      <CardContent className="p-3 space-y-3">
        ...
        <div className="flex justify-end">
          <Button className="h-7 text-[11px] bg-teal-600 hover:bg-teal-700 text-white gap-1.5 px-2.5" onClick={() => onSave({ ...form, plantType: "wtp" })}>
            <Save className="h-3.5 w-3.5" />
            Save
          </Button>
        </div>
  ...
  return (
    <Card className="shadow-none border-slate-200">
      <CardContent className="p-3 space-y-3">
        ...
        <div className="flex justify-end">
          <Button className="h-7 text-[11px] bg-teal-600 hover:bg-teal-700 text-white gap-1.5 px-2.5" onClick={() => onSave({ ...form, plantType: "pool" })}>
            <Save className="h-3.5 w-3.5" />
            Save
          </Button>
        </div>
  ...
  return (
    <Card className="shadow-none border-slate-200">
      <CardContent className="p-3 space-y-3">
        ...
        <div className="flex justify-end">
          <Button className="h-7 text-[11px] bg-teal-600 hover:bg-teal-700 text-white gap-1.5 px-2.5" onClick={() => onSave({ ...form, plantType: "ro" })}>
            <Save className="h-3.5 w-3.5" />
            Save
          </Button>
        </div>
