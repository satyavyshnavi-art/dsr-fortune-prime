                  ...
                  <tr key={p.id} className="hover:bg-slate-50/40 group">
                    ...
                    <td className="py-3 px-3">
                      <div className="flex flex-wrap gap-1">
                        {cats.length > 0 ? cats.map(cat => (
                          <span key={cat} className="inline-block rounded bg-emerald-50 text-emerald-700 text-[10px] font-medium px-1.5 py-0.5">
                            {cat}
                          </span>
                    ...
                    <td className="py-3 px-3">
                      <div className="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button onClick={() => handleEdit(p)} className="p-1 rounded hover:bg-emerald-50 text-slate-400 hover:text-emerald-700 transition-colors" title="Edit">
