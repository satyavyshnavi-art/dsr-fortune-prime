  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm" onClick={handleAdd} className="h-8 text-[12px] px-4 bg-emerald-700 hover:bg-emerald-800 text-white">
              ...
              {filtered.map((emp) => (
                <tr key={emp.id} className="hover:bg-slate-50/40 group">
                  <td className="py-3 px-3">
                    <span className="inline-block rounded bg-emerald-50 text-emerald-700 text-[11px] font-mono font-medium px-2 py-0.5">
                      {emp.empId}
                    </span>
                  </td>
                  ...
                  <td className="py-3 px-3">
                    <div className="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button onClick={() => handleEdit(emp)} className="p-1 rounded hover:bg-emerald-50 text-slate-400 hover:text-emerald-700 transition-colors" title="Edit">
