  ...
  const columns: ColumnDef<Role>[] = [
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-2">
          <div className="h-7 w-7 rounded-md bg-violet-50 flex items-center justify-center">
      ...
      cell: ({ row }) => {
        ...
        return (
          <button
            ...
            className="text-[11px] text-violet-600 hover:text-violet-700 hover:underline"
          >
