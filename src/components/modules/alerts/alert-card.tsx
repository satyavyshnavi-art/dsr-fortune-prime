        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5">
            {alert.status === "unacknowledged" && (
              <>
                <Button
                  size="sm"
                  variant="outline"
                  className="h-6 text-[10px] px-2 bg-white hover:bg-emerald-50 border-emerald-200 text-emerald-800"
            ...
            {alert.status === "resolved" && (
              <Badge className="bg-emerald-100 text-emerald-800 text-[9px] h-[16px] px-1.5">
                <CheckCircle className="h-2.5 w-2.5 mr-0.5" />
                Resolved
              </Badge>
            )}
