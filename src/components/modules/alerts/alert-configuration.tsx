    ...
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" className="h-8 text-[12px] px-3 bg-emerald-700 hover:bg-emerald-800 text-white" onClick={handleSaveConfiguration}>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2.5">
                  <CatIcon className={`h-3.5 w-3.5 ${cat.enabled ? "text-emerald-700" : "text-slate-400"}`} />
                  <span className={`text-[12px] font-medium ${cat.enabled ? "text-emerald-800" : "text-slate-600"}`}>
                    {cat.label}
                  </span>
                </div>
                <div className={`h-4.5 w-4.5 rounded flex items-center justify-center text-white transition-colors ${
                  cat.enabled ? "bg-emerald-700" : "border border-slate-300 bg-white"
                }`}>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`h-7 w-7 rounded-md flex items-center justify-center ${
                      channel.enabled ? "bg-emerald-50" : "bg-slate-100"
                    }`}>
                      <Icon className={`h-3.5 w-3.5 ${channel.enabled ? "text-emerald-700" : "text-slate-400"}`} />
                    </div>
                    <div>
      ...
      <div className="flex items-center justify-end gap-2 pt-1 pb-6">
        ...
        <Button size="sm" className="h-8 text-[12px] px-4 bg-emerald-700 hover:bg-emerald-800 text-white" onClick={handleSaveConfiguration}>
          <CheckCircle className="h-3 w-3 mr-1.5" />
          Save Configuration
        </Button>
      </div>
