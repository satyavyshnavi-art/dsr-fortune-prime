      ...
      <DialogContent className="sm:max-w-[480px] p-5" showCloseButton>
        ...
        <div className="space-y-3 pt-1">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="inline-block bg-emerald-50 text-emerald-800 font-mono text-[12px] px-2.5 py-1 rounded border border-emerald-200">
              {nextEmpId}
            </span>
          </div>
    ...
    <div className="flex flex-col items-center py-4">
      ...
      <div className="flex items-center gap-3">
        <Button
          size="sm"
          onClick={handleCopy}
          className="h-7 text-[11px] px-4 bg-emerald-700 hover:bg-emerald-800 text-white"
        >
          {copied ? (
            <>
